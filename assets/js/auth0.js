!function (e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = "undefined" != typeof globalThis ? globalThis : e || self).auth0 = {})
}
(this, (function (e) {
        "use strict";
        function t(e, t) {
        ...
        var s = i((function (e, t) {
                    var n = o && o.__awaiter || function (e, t, o, n) {
                    ...
                    i = o && o.__generator || function (e, t) {
                        var o,
                        n,
                        i,
                        r,
                        ...
                        function a(r) {
                            return function (a) {
                                return function (r) {
                                    ...
                                    for (; s; )
                                        try {
                                            if (o = 1, n && (i = 2 & r[0] ? n.return : r[0] ? n.throw || ((i = n.return) && i.call(n), 0) : n.next) && !(i = i.call(n, r[1])).done)
                                                return i;
                    ...
                    var h = function () {
                            ...
                            n(this, void 0, void 0, (function () {
                                    ...
                                    return i(this, (function (i) {
                                            ...
                                            case 0:
                                                ...
                                                r = Date.now() + o,
                                                s = a + "-" + t,
                                                h = void 0 === this.storageHandler ? c : this.storageHandler,
                                                i.label = 1;
                                            case 1:
                                                return Date.now() < r ? [4, u(30)] : [3, 8];
                                            case 2:
                                                return i.sent(),
                                                null !== h.getItemSync(s) ? [3, 5] : (l = this.id + "-" + t + "-" + n, [4, u(Math.floor(25 * Math.random()))]);
                                            case 3:
                                                return i.sent(),
                                                h.setItemSync(s, JSON.stringify({
                                                        id: this.id,
                                                        iat: n,
                                                        timeoutKey: l,
                                            ...
                                            case 4:
                                                return i.sent(),
                                                null !== (p = h.getItemSync(s)) && (m = JSON.parse(p)).id === this.id && m.iat === n ? (this.acquiredIatSet.add(n), this.refreshLockWhileAcquired(s, n), [2, !0]) : [3, 7];
                                            case 5:
                                                return e.lockCorrector(void 0 === this.storageHandler ? c : this.storageHandler),
                                                [4, this.waitForSomethingToChange(r)];
                                            case 6:
                                                i.sent(),
                                                i.label = 7;
                                            case 7:
                                                return n = Date.now() + d(4),
                                                [3, 1];
                                            case 8:
                                                return [2, !1]
                                            }
                                            ...
                                            return setTimeout((function () {
                                                    return n(o, void 0, void 0, (function () {
                                                            ...
                                                            return i(this, (function (i) {
                                                                    switch (i.label) {
                                                                    case 0:
                                                                        return [4, r.default().lock(t)];
                                                                    case 1:
                                                                        return i.sent(),
                                                                        this.acquiredIatSet.has(t) ? (o = void 0 === this.storageHandler ? c : this.storageHandler, null === (n = o.getItemSync(e)) ? (r.default().unlock(t), [2]) : ((s = JSON.parse(n)).timeRefreshed = Date.now(), o.setItemSync(e, JSON.stringify(s)), r.default().unlock(t), this.refreshLockWhileAcquired(e, t), [2])) : (r.default().unlock(t), [2])
                                                                    }
                                                                }))
                                                        }))
                                                }), 1e3),
                        ...
                        e.prototype.releaseLock__private__ = function (t) {
                            return n(this, void 0, void 0, (function () {
                                    ...
                                    return i(this, (function (i) {
                                            switch (i.label) {
                                            case 0:
                                                return o = void 0 === this.storageHandler ? c : this.storageHandler,
                                                n = a + "-" + t,
                                                null === (s = o.getItemSync(n)) ? [2] : (u = JSON.parse(s)).id !== this.id ? [3, 2] : [4, r.default().lock(u.iat)];
                                            case 1:
                                                i.sent(),
                                                this.acquiredIatSet.delete(u.iat),
                                                o.removeItemSync(n),
                                                r.default().unlock(u.iat),
                                                e.notifyWaiters(),
                                                i.label = 2;
                                            case 2:
                                                return [2]
                        ...
                        e.lockCorrector = function (t) {
                            ...
                            for (var c = !1, u = 0; u < i.length; u++) {
                                var d = i[u];
                                if (d.includes(a)) {
                                    var h = n.getItemSync(d);
                                    if (null !== h) {
                                        var l = JSON.parse(h);
                                        (void 0 === l.timeRefreshed && l.timeAcquired < o || void 0 !== l.timeRefreshed && l.timeRefreshed < o) && (n.removeItemSync(d), c = !0)
                                    }
                                }
                            }
                            c && e.notifyWaiters()
        ...
        class w extends l {
            constructor(e, t) {
                super("missing_refresh_token", `Missing Refresh Token (audience: '${k(e, ["default"])}', scope: '${k(t)}')`),
                this.audience = e,
                this.scope = t,
        ...
        const v = () => window.crypto,
        _ = () => {
            const e = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_~.";
            let t = "";
            return Array.from(v().getRandomValues(new Uint8Array(43))).forEach((o => t += e[o % e.length])),
            t
        },
        I = e => btoa(e),
        S = e => {
        ...
        T = e => (e => decodeURIComponent(atob(e).split("").map((e => "%" + ("00" + e.charCodeAt(0).toString(16)).slice(-2))).join("")))(e.replace(/_/g, "/").replace(/-/g, "+")),
        P = new TextEncoder,
        O = new TextDecoder;
        function x(e) {
            return "string" == typeof e ? P.encode(e) : O.decode(e)
        }
        function K(e) {
            if ("number" != typeof e.modulusLength || e.modulusLength < 2048)
                throw new N(`${e.name} modulusLength must be at least 2048 bits`)
        }
        async function E(e, t, o) {
            if (!1 === o.usages.includes("sign"))
                throw new TypeError('private CryptoKey instances used for signing assertions must include "sign" in their "usages"');
            const n = `${C(x(JSON.stringify(e)))}.${C(x(JSON.stringify(t)))}`;
            return `${n}.${C(await crypto.subtle.sign(function (e) {
        ...
        if (Uint8Array.prototype.toBase64)
            j = e => (e instanceof ArrayBuffer && (e = new Uint8Array(e)), e.toBase64({
                        alphabet: "base64url",
                        omitPadding: !0
                    }));
        else {
            ...
            j = t => {
                ...
                const o = [];
                for (let n = 0; n < t.byteLength; n += e)
                    o.push(String.fromCharCode.apply(null, t.subarray(n, n + e)));
        ...
        class z extends Error {
            constructor(e) {
                var t;
                super(null != e ? e : "operation not supported"),
                this.name = this.constructor.name,
                null === (t = Error.captureStackTrace) || void 0 === t || t.call(Error, this, this.constructor)
            }
        }
        ...
        function D(e) {
            ...
            case "RSA-PSS":
                return function (e) {
                    if ("SHA-256" === e.algorithm.hash.name)
                        return "PS256";
                    throw new z("unsupported RsaHashedKeyAlgorithm hash name")
                }
                (e);
            case "RSASSA-PKCS1-v1_5":
                return function (e) {
            ...
            case "ECDSA":
                return function (e) {
                    if ("P-256" === e.algorithm.namedCurve)
                        return "ES256";
                    throw new z("unsupported EcKeyAlgorithm namedCurve")
                }
                (e);
            case "Ed25519":
                return "Ed25519";
            default:
                throw new z("unsupported CryptoKey algorithm name")
            }
        }
        function Z(e) {
        ...
        async function U(e, t, o, n, i, r) {
            ...
            if (void 0 !== r && ("object" != typeof r || null === r || Array.isArray(r)))
            ...
            return E({
                ...
                jwk: await L(a)
                    ...
                    nonce: n,
                    htu: t,
                    ath: i ? C(await crypto.subtle.digest("SHA-256", x(i))) : void 0
                }), s)
        }
        async function L(e) {
            const { kty: t, e: o, n: n, x: i, y: r, crv: s } = await crypto.subtle.exportKey("jwk", e);
            return {
                kty: t,
                crv: s,
                e: o,
        ...
        const W = "dpop-nonce",
        A = ["authorization_code", "refresh_token", "urn:ietf:params:oauth:grant-type:token-exchange"];
        function H() {
        ...
        function J(e) {
            return async function (e) {
                ...
                case "RSA":
                    ...
                    break;
                default:
                    throw new z("unsupported JWK kty")
                }
                return C(await crypto.subtle.digest({
                        name: "SHA-256"
                    }, x(JSON.stringify(o))))
            }
            (e.publicKey)
        ...
        G = async(e, t, o) => {
            ...
            Promise.race([V(e, t), new Promise(((e, t) => {
                            i = setTimeout((() => {
                                        n.abort(),
        ...
        M = async(e, t, o, n, i, r, s = 1e4, a) => i ? F(e, t, o, n, s, i, r, a) : G(e, n, s);
        async function Y(e, o, n, i, r, s, a, c, u, d) {
            if (u) {
            ...
            k = t(m, ["error", "error_description"]), {
                headers: v,
                ok: _
            } = h;
            let I;
            if (u && (I = v["dpop-nonce"], I && await u.setNonce(I)), !_) {
                const t = g || `HTTP error. Unable to fetch ${e}`;
                if ("mfa_required" === f)
                    throw new y(f, t, k.mfa_token);
                if ("missing_refresh_token" === f)
                    throw new w(n, i);
                if ("use_dpop_nonce" === f) {
                    if (!u || !I || d)
                        throw new b(I);
                    return Y(e, o, n, i, r, s, a, c, u, !0)
                }
                throw new l(f || "request_error", t)
            }
            return k
        }
        async function $(e, o) {
            var { baseUrl: n, timeout: i, audience: r, scope: s, auth0Client: a, useFormData: c, useMrrt: u, dpop: h } = e,
            l = t(e, ["baseUrl", "timeout", "audience", "scope", "auth0Client", "useFormData", "useMrrt", "dpop"]);
            const p = "urn:ietf:params:oauth:grant-type:token-exchange" === l.grant_type,
            m = "refresh_token" === l.grant_type && u,
            ...
            g = c ? S(f) : JSON.stringify(f),
            y = (w = l.grant_type, A.includes(w));
            var w;
            return await Y(`${n}/oauth/token`, i, r || "default", s, {
                method: "POST",
                body: g,
                headers: {
                    "Content-Type": c ? "application/x-www-form-urlencoded" : "application/json",
                    "Auth0-Client": btoa(JSON.stringify(a || d))
                }
            }, o, c, u, y ? h : void 0)
        }
        const q = (...e) => {
        ...
        class te {
            ...
            allKeys() {
                return Object.keys(window.localStorage).filter((e => e.startsWith(B)))
            }
        }
        class oe {
            constructor() {
        ...
        class ne {
            ...
            async setIdToken(e, t, o) {
                ...
                await(null === (n = this.keyManifest) || void 0 === n ? void 0 : n.add(i))
            }
            async getIdToken(e) {
            ...
            async get(e, t = 0, o = !1, n) {
                ...
                if (!r) {
                    ...
                    if (i && (r = await this.cache.get(i)), !i && o && "cache-only" !== n)
                        return this.getEntryWithRefreshToken(e, t)
                }
                if (!r)
                    return;
            ...
            async set(e) {
                ...
                n = await this.wrapCacheEntry(e);
                await this.cache.set(o.toKey(), n),
                await(null === (t = this.keyManifest) || void 0 === t ? void 0 : t.add(o.toKey()))
            }
            async clear(e) {
                var t;
                const o = await this.getCacheKeys();
                o && (await o.filter((t => !e || t.includes(e))).reduce((async(e, t) => {
                            await e,
                            await this.cache.remove(t)
            ...
            matchExistingCacheKey(e, t) {
                return t.filter((t => {
                        var o;
                        const n = ee.fromKey(t),
                        i = new Set(n.scope && n.scope.split(" ")),
                        r = (null === (o = e.scope) || void 0 === o ? void 0 : o.split(" ")) || [],
                        s = n.scope && r.reduce(((e, t) => e && i.has(t)), !0);
                        return n.prefix === B && n.clientId === e.clientId && n.audience === e.audience && s
                    }))[0]
            }
            async getEntryWithRefreshToken(e, t) {
                var o;
                for (const n of t) {
                    const t = ee.fromKey(n);
                    if (t.prefix === B && t.clientId === e.clientId) {
                        const t = await this.cache.get(n);
                        if (null === (o = null == t ? void 0 : t.body) || void 0 === o ? void 0 : o.refresh_token)
                            return this.modifiedCachedEntry(t, e)
                    }
                }
            }
            async updateEntry(e, t) {
                ...
                if (n)
                    for (const i of n) {
                        const n = await this.cache.get(i);
        ...
        const re = e => "number" == typeof e,
        se = ["iss", "aud", "exp", "nbf", "iat", "jti", "azp", "nonce", "auth_time", "at_hash", "c_hash", "acr", "amr", "sub_jwk", "cnf", "sip_from_tag", "sip_date", "sip_callid", "sip_cseq_num", "sip_via_branch", "orig", "dest", "mky", "events", "toe", "txn", "rph", "sid", "vot", "vtm"],
        ae = e => {
            if (!e.id_token)
            ...
            if (!t.claims.aud || "string" != typeof t.claims.aud && !Array.isArray(t.claims.aud))
            ...
            if (e.max_age && !re(t.claims.auth_time))
                throw new Error("Authentication Time (auth_time) claim must be a number present in the ID token when Max Age (max_age) is specified");
            if (null == t.claims.exp || !re(t.claims.exp))
            ...
            i = new Date(0);
            if (i.setUTCSeconds(t.claims.exp + o), n > i)
                throw new Error(`Expiration Time (exp) claim error in the ID token; current time (${n}) is after expiration time (${i})`);
            if (null != t.claims.nbf && re(t.claims.nbf)) {
                const e = new Date(0);
                if (e.setUTCSeconds(t.claims.nbf - o), n < e)
                    throw new Error(`Not Before time (nbf) claim in the ID token indicates that this token can't be used just yet. Current time (${n}) is before ${e}`)
            }
            if (null != t.claims.auth_time && re(t.claims.auth_time)) {
                const i = new Date(0);
                if (i.setUTCSeconds(parseInt(t.claims.auth_time) + e.max_age + o), n > i)
                    throw new Error(`Authentication Time (auth_time) claim in the ID token indicates that too much time has passed since the last end-user authentication. Current time (${n}) is after last auth at ${i}`)
            }
            if (e.organization) {
                ...
                if (o.startsWith("org_")) {
                    ...
                    if (e !== t.claims.org_id)
                        throw new Error(`Organization ID (org_id) claim mismatch in the ID token; expected "${e}", found "${t.claims.org_id}"`)
                } else {
                    const e = o.toLowerCase();
                    if (!t.claims.org_name)
                        throw new Error("Organization Name (org_name) claim must be a string present in the ID token");
                    if (e !== t.claims.org_name)
                        throw new Error(`Organization Name (org_name) claim mismatch in the ID token; expected "${e}", found "${t.claims.org_name}"`)
                }
            }
            return t
        };
        var ce = i((function (e, t) {
                    var n = o && o.__assign || function () {
        ...
        const le = {
            ...
            save(e, t, o) {
                ...
                (null == o ? void 0 : o.daysUntilExpire) && (n.expires = o.daysUntilExpire),
                (null == o ? void 0 : o.cookieDomain) && (n.domain = o.cookieDomain),
                de(e, JSON.stringify(t), n)
            },
            remove(e, t) {
                let o = {};
                (null == t ? void 0 : t.cookieDomain) && (o.domain = t.cookieDomain),
                he(e, o)
            }
        },
        pe = {
            ...
            save(e, t, o) {
                ...
                (null == o ? void 0 : o.daysUntilExpire) && (n.expires = o.daysUntilExpire),
                (null == o ? void 0 : o.cookieDomain) && (n.domain = o.cookieDomain),
                de(`_legacy_${e}`, JSON.stringify(t), n),
                le.save(e, t, o)
            },
            remove(e, t) {
                let o = {};
        ...
        function fe(e, t, o) {
            ...
            i = function (e, t) {
                var o = atob(e);
                if (t) {
                    for (var n = new Uint8Array(o.length), i = 0, r = o.length; i < r; ++i)
                        n[i] = o.charCodeAt(i);
        ...
        class _e {
            ...
            async add(e) {
                var t;
                const o = new Set((null === (t = await this.cache.get(this.manifestKey)) || void 0 === t ? void 0 : t.keys) || []);
                o.add(e),
        ...
        const Ie = "auth0.lock.getTokenSilently",
        Se = "auth0.is.authenticated",
        Te = {
        ...
        Pe = e => Te[e],
        Oe = e => {
            const { openUrl: o, onRedirect: n } = e,
            i = t(e, ["openUrl", "onRedirect"]);
        ...
        class Ee {
            ...
            createDbHandle() {
                ...
                return new Promise(((t, o) => {
                        e.onupgradeneeded = () => Object.values(Ke).forEach((t => e.result.createObjectStore(t))),
                        e.onerror = () => o(e.error),
                        e.onsuccess = () => t(e.result)
                    }))
            }
            async getDbHandle() {
                return this.dbHandle || (this.dbHandle = await this.createDbHandle()),
                this.dbHandle
            }
            ...
            setNonce(e, t) {
                return this.save(Ke.NONCE, this.buildKey(t), e)
            }
            setKeyPair(e) {
                return this.save(Ke.KEYPAIR, this.buildKey(), e)
            }
            async save(e, t, o) {
                await this.executeDbRequest(e, "readwrite", (e => e.put(o, t)))
            }
            findNonce(e) {
                return this.find(Ke.NONCE, this.buildKey(e))
            }
            findKeyPair() {
            ...
            async deleteBy(e, t) {
                const o = await this.executeDbRequest(e, "readonly", (e => e.getAllKeys()));
                null == o || o.filter(t).map((t => this.executeDbRequest(e, "readwrite", (e => e.delete(t)))))
            }
        ...
        class je {
            ...
            async getOrGenerateKeyPair() {
                ...
                return e || (e = await H(), await this.storage.setKeyPair(e)),
                e
            }
        ...
        class Ce {
            ...
            async setDpopProofHeader(e, t) {
                if (!this.config.dpopNonceId)
                    return;
                const o = await this.hooks.getDpopNonce(),
                n = await this.hooks.generateDpopProof({
                    accessToken: t,
                    method: e.method,
                    nonce: o,
                    url: e.url
            ...
            async prepareRequest(e, t) {
                ...
                this.setAuthorizationHeader(e, o),
                await this.setDpopProofHeader(e, o)
            }
            getHeader(e, t) {
            ...
            async handleResponse(e, t) {
                const o = this.getHeader(e.headers, W);
                if (o && await this.hooks.setDpopNonce(o), !this.hasUseDpopNonceError(e))
                    return e;
                if (!o || !t.onUseDpopNonceError)
                    throw new b(o);
                return t.onUseDpopNonceError()
            }
            async internalFetchWithAuth(e, t, o, n) {
                const i = this.buildBaseRequest(e, t);
                await this.prepareRequest(i, n);
        ...
        class Ne {
            constructor(e) {
                let t,
                o;
                if (this.userCache = (new oe).enclosedCache, this.defaultOptions = {
                        authorizationParams: {
                    ...
                    if (t = e.cacheLocation || u, !Pe(t))
                        throw new Error(`Invalid cache location "${t}"`);
                    o = Pe(t)()
                }
                this.httpTimeoutMs = e.httpTimeoutInSeconds ? 1e3 * e.httpTimeoutInSeconds : 1e4,
                this.cookieStorage = !1 === e.legacySameSiteCookie ? le : pe,
                this.orgHintCookieName = `auth0.${this.options.clientId}.organization_hint`,
                this.isAuthenticatedCookieName = (e => `auth0.${e}.is.authenticated`)(this.options.clientId),
                this.sessionCheckExpiryDays = e.sessionCheckExpiryDays || 1;
                const n = e.useCookiesForTransactions ? this.cookieStorage : me;
                var i;
                this.scope = q("openid", this.options.authorizationParams.scope, this.options.useRefreshTokens ? "offline_access" : ""),
                this.transactionManager = new ie(n, this.options.clientId, this.options.cookieDomain),
                this.nowProvider = this.options.nowProvider || h,
                this.cacheManager = new ne(o, o.allKeys ? void 0 : new _e(o, this.options.clientId), this.nowProvider),
                this.dpop = this.options.useDpop ? new je(this.options.clientId) : void 0,
                this.domainUrl = (i = this.options.domain, /^https?:\/\//.test(i) ? i : `https://${i}`),
                this.tokenIssuer = ((e, t) => e ? e.startsWith("https://") ? e : `https://${e}/` : `${t}/`)(this.options.issuer, this.domainUrl),
                "undefined" != typeof window && window.Worker && this.options.useRefreshTokens && t === u && (this.options.workerUrl ? this.worker = new Worker(this.options.workerUrl) : this.worker = new ke)
            }
            _url(e) {
                const t = encodeURIComponent(btoa(JSON.stringify(this.options.auth0Client || d)));
            ...
            async _prepareAuthorizeUrl(e, t, o) {
                ...
                a = (e => {
                    ...
                    return (e => {
                        ...
                        const t = v().subtle.digest({
                            name: "SHA-256"
                        }, (new TextEncoder).encode(e));
                        return await t
                    })(s)),
                c = await(null === (n = this.dpop) || void 0 === n ? void 0 : n.calculateThumbprint()),
                u = ((e, t, o, n, i, r, s, a, c) => Object.assign(Object.assign(Object.assign({
                        ...
                        dpop_jkt: c
                    }))(this.options, this.scope, e, i, r, a, e.redirect_uri || this.options.authorizationParams.redirect_uri || o, null == t ? void 0 : t.response_mode, c),
                d = this._authorizeUrl(u);
                return {
                    nonce: r,
                    code_verifier: s,
                    scope: u.scope,
            ...
            async loginWithPopup(e, t) {
                ...
                const n = await this._prepareAuthorizeUrl(e.authorizationParams || {}, {
                ...
                const i = await(e => new Promise(((t, o) => {
                                let n;
                                const i = setInterval((() => {
                                            e.popup && e.popup.closed && (clearInterval(i), clearTimeout(r), window.removeEventListener("message", n, !1), o(new g(e.popup)))
                                        }), 1e3),
                                r = setTimeout((() => {
                                            clearInterval(i),
                                            o(new f(e.popup)),
                                ...
                                n = function (s) {
                                    if (s.data && "authorization_response" === s.data.type) {
                                        if (clearTimeout(r), clearInterval(i), window.removeEventListener("message", n, !1), e.popup.close(), s.data.response.error)
                                            return o(l.fromPayload(s.data.response));
                                        t(s.data.response)
                                    }
                                },
                ...
                if (n.state !== i.state)
                    throw new l("state_mismatch", "Invalid state");
                const r = (null === (o = e.authorizationParams) || void 0 === o ? void 0 : o.organization) || this.options.authorizationParams.organization;
            ...
            async loginWithRedirect(e = {}) {
                ...
                a = t(n, ["openUrl", "fragment", "appState"]),
                c = (null === (o = a.authorizationParams) || void 0 === o ? void 0 : o.organization) || this.options.authorizationParams.organization,
                u = await this._prepareAuthorizeUrl(a.authorizationParams || {}), {
                    url: d
                } = u,
                h = t(u, ["url"]);
            ...
            async handleRedirectCallback(e = window.location.href) {
                ...
                const { state: o, code: n, error: i, error_description: r } = (e => {
                ...
                if (!s)
                    throw new l("missing_transaction", "Invalid state");
                if (this.transactionManager.remove(), i)
                    throw new p(i, r || i, o, s.appState);
                if (!s.code_verifier || s.state && s.state !== o)
                    throw new l("state_mismatch", "Invalid state");
            ...
            async checkSession(e) {
                if (!this.cookieStorage.get(this.isAuthenticatedCookieName)) {
                    if (!this.cookieStorage.get(Se))
                        return;
                    this.cookieStorage.save(this.isAuthenticatedCookieName, !0, {
                        daysUntilExpire: this.sessionCheckExpiryDays,
                        cookieDomain: this.options.cookieDomain
                    }),
                    this.cookieStorage.remove(Se)
                }
                try {
            ...
            async getTokenSilently(e = {}) {
                ...
                const o = Object.assign(Object.assign({
                        ...
                        authorizationParams: Object.assign(Object.assign(Object.assign({}, this.options.authorizationParams), e.authorizationParams), {
                            scope: q(this.scope, null === (t = e.authorizationParams) || void 0 === t ? void 0 : t.scope)
                        })
                    }),
                n = await((e, t) => {
                    let o = ve[t];
                    ...
                    if (!await(async(e, t = 3) => {
                            for (let o = 0; o < t; o++)
                                if (await e())
                                    return !0;
                            return !1
                        })((() => ze.acquireLock(Ie, 5e3)), 10))
                        throw new m;
                    try {
                        if (window.addEventListener("pagehide", this._releaseLockOnPageHide), "off" !== o) {
                            const e = await this._getEntryFromCache({
                                scope: n.authorizationParams.scope,
                                audience: n.authorizationParams.audience || "default",
                                clientId: this.options.clientId
                        ...
                        const e = this.options.useRefreshTokens ? await this._getTokenUsingRefreshToken(n) : await this._getTokenFromIFrame(n), {
                            id_token: t,
                            token_type: i,
                            access_token: r,
                            oauthTokenScope: s,
            ...
            async getTokenWithPopup(e = {}, t = {}) {
                ...
                const n = Object.assign(Object.assign({}, e), {
                    authorizationParams: Object.assign(Object.assign(Object.assign({}, this.options.authorizationParams), e.authorizationParams), {
                        scope: q(this.scope, null === (o = e.authorizationParams) || void 0 === o ? void 0 : o.scope)
                    })
                });
                t = Object.assign(Object.assign({}, c), t),
                await this.loginWithPopup(n, t);
                return (await this.cacheManager.get(new ee({
                            scope: n.authorizationParams.scope,
                            audience: n.authorizationParams.audience || "default",
                            clientId: this.options.clientId
            ...
            async logout(e = {}) {
                ...
                r = t(n, ["openUrl"]);
                null === e.clientId ? await this.cacheManager.clear() : await this.cacheManager.clear(e.clientId || this.options.clientId),
                this.cookieStorage.remove(this.orgHintCookieName, {
                    cookieDomain: this.options.cookieDomain
                }),
                ...
                this.userCache.remove(Q),
                await(null === (o = this.dpop) || void 0 === o ? void 0 : o.clear());
            ...
            async _getTokenFromIFrame(e) {
                ...
                const { url: n, state: i, nonce: r, code_verifier: s, redirect_uri: a, scope: c, audience: u } = await this._prepareAuthorizeUrl(t, {
                    response_mode: "web_message"
                }, window.location.origin);
                try {
                    if (window.crossOriginIsolated)
                        throw new l("login_required", "The application is running in a Cross-Origin Isolated context, silently retrieving a token without refresh token is not possible.");
                    const o = e.timeoutInSeconds || this.options.authorizeTimeoutInSeconds;
                    let d;
                    try {
                    ...
                    const h = await((e, t, o = 60) => new Promise(((n, i) => {
                                    ...
                                    a = function (e) {
                                        ...
                                        const o = e.source;
                                        o && o.close(),
                                        e.data.response.error ? i(l.fromPayload(e.data.response)) : n(e.data.response),
                                        clearTimeout(c),
            ...
            async _getTokenUsingRefreshToken(e) {
                const t = await this.cacheManager.get(new ee({
                ...
                if (!(t && t.refresh_token || this.worker)) {
                    ...
                    throw new w(e.authorizationParams.audience || "default", e.authorizationParams.scope)
                }
                const o = e.authorizationParams.redirect_uri || this.options.authorizationParams.redirect_uri || window.location.origin,
                ...
                try {
                    ...
                    if (u.refresh_token && this.options.useMrrt && (null == t ? void 0 : t.refresh_token) && await this.cacheManager.updateEntry(t.refresh_token, u.refresh_token), this.options.useMrrt) {
                        if (r = null == t ? void 0 : t.audience, s = null == t ? void 0 : t.scope, a = e.authorizationParams.audience, c = e.authorizationParams.scope, r !== a || !xe(c, s)) {
                            if (!xe(i, u.scope)) {
                                if (this.options.useRefreshTokensFallback)
                                    return await this._getTokenFromIFrame(e);
                                throw new w(e.authorizationParams.audience || "default", e.authorizationParams.scope)
                    ...
                    if ((t.message.indexOf("Missing Refresh Token") > -1 || t.message && t.message.indexOf("invalid refresh token") > -1) && this.options.useRefreshTokensFallback)
                        return await this._getTokenFromIFrame(e);
                    throw t
                }
                var r,
            ...
            async _saveEntryInCache(e) {
                const { id_token: o, decodedToken: n } = e,
                i = t(e, ["id_token", "decodedToken"]);
                this.userCache.set(Q, {
                    id_token: o,
                    decodedToken: n
                }),
            ...
            async _getIdTokenFromCache() {
                ...
                t = await this.cacheManager.getIdToken(new ee({
                            clientId: this.options.clientId,
                            audience: e,
                            scope: this.scope
                        })),
                o = this.userCache.get(Q);
                return t && t.id_token === (null == o ? void 0 : o.id_token) ? o : (this.userCache.set(Q, t), t)
            }
            async _getEntryFromCache({
                ...
                const i = await this.cacheManager.get(new ee({
                            scope: e,
                            audience: t,
                            clientId: o
                        }), 60, this.options.useMrrt, n);
                if (i && i.access_token) {
                    const { token_type: e, access_token: t, oauthTokenScope: o, expires_in: n } = i,
                    r = await this._getIdTokenFromCache();
            ...
            async _requestToken(e, t) {
                const { nonceIn: o, organization: n, scopesToRequest: i } = t || {},
                r = await $(Object.assign(Object.assign({
                ...
                s = await this._verifyIdToken(r.id_token, o, n);
                ...
                this._processOrgHint(n || s.claims.org_id),
                Object.assign(Object.assign({}, r), {
                    decodedToken: s
                })
            }
            ...
            getDpopNonce(e) {
                return this._assertDpop(this.dpop),
                this.dpop.getNonce(e)
            }
            setDpopNonce(e, t) {
                return this._assertDpop(this.dpop),
                this.dpop.setNonce(e, t)
            }
            generateDpopProof(e) {
                return this._assertDpop(this.dpop),
                this.dpop.generateProof(e)
            }
            createFetcher(e = {}) {
                if (this.options.useDpop && !e.dpopNonceId)
        ...
        e.Auth0Client = Ne,
        e.AuthenticationError = p,
        e.CacheKey = ee,
        e.GenericError = l,
        e.InMemoryCache = oe,
        e.LocalStorageCache = te,
        e.MfaRequiredError = y,
        e.MissingRefreshTokenError = w,
        e.PopupCancelledError = g,
        e.PopupTimeoutError = f,
        e.TimeoutError = m,
        e.UseDpopNonceError = b,
        e.User = class {},
        e.createAuth0Client = async function (e) {
            const t = new Ne(e);
            return await t.checkSession(),
            t
        },
